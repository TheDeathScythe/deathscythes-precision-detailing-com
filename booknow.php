...
<html lang="en">
<head>
  <title>Book Now | Scythe's Precision Detailing</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="d-flex justify-content-center">
    <div style="background: #FFF; border-radius: 5px; margin-top: 10px; text-align: center; width:75%; padding:5px;">
      <h1>This feature is a work in progress.</h1>
      <p>Check back here soon to book an appointment right at the palm of your hand!</p>
    </div>
  </div>
